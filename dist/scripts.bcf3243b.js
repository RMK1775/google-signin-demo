...
},{"@firebase/app":"../node_modules/@firebase/app/dist/index.esm.js"}],"scripts/firebase/firebaseConfig.js":[function(require,module,exports) {
"use strict";
...
},{"@firebase/auth":"../node_modules/@firebase/auth/dist/auth.esm.js"}],"scripts/util.js":[function(require,module,exports) {
"use strict";
...
var clickHandler = function clickHandler(elementId, handlerFn) {
...
},{"firebase/app":"../node_modules/firebase/app/dist/index.esm.js","firebase/auth":"../node_modules/firebase/auth/dist/index.esm.js"}],"scripts/firebase/firebaseAuthentication.js":[function(require,module,exports) {
"use strict";
...
var googleSignIn = function googleSignIn() {
  ...
  _app.default.auth().signInWithPopup(provider).then(function (result) {
    return console.log("Successfully logged in with Google", result.user);
  }).catch(function (error) {
    return console.error("There was a sign-in error with Google: ", error);
  });
};
...
var googleSignOut = function googleSignOut() {
  _app.default.auth().signOut().then(function () {
    ...
    return console.error("Oops, something went awry.", error);
  });
};
...
(0, _util.clickHandler)("signin-google", (0, _firebaseAuthentication.googleSignIn)());
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "60795" + '/');
